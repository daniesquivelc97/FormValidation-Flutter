...
class ProductosProvider {
 final String _url = 'https://flutter-varios-2f7b8-default-rtdb.firebaseio.com';
 ...
 Future<String> subirImagen(File imagen) async {
   final url = Uri.parse('https://api.cloudinary.com/v1_1/dypakjqqv/image/upload?upload_preset=hlduwapi');
